...
Скачайте последний бинарный файл для вашей операционной системы со страницы [релизов](https://github.com/quadgod/pgm/releases). Выберите соответствующий архив для вашей платформы:
...
Распакуйте архив и поместите бинарный файл в директорию PATH.
...
В данный момент недоступен через менеджеры пакетов, но можно собрать из исходного кода.
